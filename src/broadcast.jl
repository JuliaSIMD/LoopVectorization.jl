...
using ..LoopVectorization:
  NativeTypes, Broadcasted, Product, vmaterialize_fun, @turbo, ArrayInterface
_is_not_one(x) = x !== 1
@inline _dontbc(x) = map(_is_not_one, ArrayInterface.known_size(x))
...
using .Vmaterialize: vmaterialize, vmaterialize!
