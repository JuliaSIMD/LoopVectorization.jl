function _precompile_()
    ...
    precompile(Tuple{Type{Expr},LoopVectorization.Instruction})
    precompile(Tuple{Type{LoopVectorization.LoopSet},Expr,Module})
    precompile(Tuple{Type{LoopVectorization.LoopSet},Expr})
    precompile(Tuple{Type{LoopVectorization.Loop},LoopVectorization.LoopSet,Int64,Type{StaticUnitRange{-1,1}}})
    precompile(Tuple{Type{LoopVectorization.Loop},LoopVectorization.LoopSet,Int64,Type{StaticUnitRange{1,69}}})
    precompile(Tuple{Type{LoopVectorization.Loop},LoopVectorization.LoopSet,Int64,Type{StaticUnitRange{1,73}}})
    precompile(Tuple{Type{LoopVectorization.Loop},LoopVectorization.LoopSet,Int64,Type{StaticUnitRange{1,75}}})
    ...
    precompile(Tuple{Type{LoopVectorization.Loop},LoopVectorization.LoopSet,Int64,Type{VectorizationBase.StaticLowerUnitRange{2}}})
    ...
    precompile(Tuple{typeof(LoopVectorization.add_mref!),LoopVectorization.LoopSet,LoopVectorization.ArrayReferenceMeta,Int64,Type{LoopVectorization.OffsetStridedPointer{Float32,2,VectorizationBase.StaticStridedPointer{Float32,Tuple{1,3}}}}})
    precompile(Tuple{typeof(LoopVectorization.add_mref!),LoopVectorization.LoopSet,LoopVectorization.ArrayReferenceMeta,Int64,Type{LoopVectorization.OffsetStridedPointer{Float64,2,VectorizationBase.StaticStridedPointer{Float64,Tuple{1,3}}}}})
    ...
    precompile(Tuple{typeof(LoopVectorization.convolution_cost_factor),LoopVectorization.LoopSet,LoopVectorization.Operation,Symbol,Symbol,Symbol})
    ...
    precompile(Tuple{typeof(LoopVectorization.fillorder!),LoopVectorization.LoopSet,Array{Symbol,1},Symbol,Symbol,Bool})
    ...
    precompile(Tuple{typeof(LoopVectorization.hasscope),Expr,Tuple{Symbol,Symbol,Symbol}})
    precompile(Tuple{typeof(LoopVectorization.hasscope),Expr,Tuple{Symbol,Symbol}})
    precompile(Tuple{typeof(LoopVectorization.incrementloopcounter),LoopVectorization.UnrollSpecification,Int64,Symbol,Symbol,Int64})
    precompile(Tuple{typeof(LoopVectorization.indexappearences),LoopVectorization.Operation,Symbol})
    precompile(Tuple{typeof(LoopVectorization.init_remblock),LoopVectorization.Loop,Symbol})
    precompile(Tuple{typeof(LoopVectorization.initialize_outer_reductions!),Expr,LoopVectorization.Operation,Int64,Int64,Symbol,Symbol,Nothing})
    precompile(Tuple{typeof(LoopVectorization.isscopedname),Expr,Symbol,Symbol})
    precompile(Tuple{typeof(LoopVectorization.isscopedname),Expr,Tuple{Symbol,Symbol,Symbol},Symbol})
    precompile(Tuple{typeof(LoopVectorization.isscopedname),Expr,Tuple{Symbol,Symbol},Symbol})
    ...
    precompile(Tuple{typeof(LoopVectorization.lower),LoopVectorization.LoopSet,Array{Symbol,1},Symbol,Symbol,Symbol,Int64,Int64})
    precompile(Tuple{typeof(LoopVectorization.lower),LoopVectorization.LoopSet,LoopVectorization.UnrollSpecification})
    ...
    precompile(Tuple{typeof(LoopVectorization.vec_looprange),LoopVectorization.Loop,Symbol,Int64,Symbol})
